...
func newTeamsCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		PersistentPreRun: func(cmd *cobra.Command, args []string) {
			...
			if !c.IsV2() {
				handleError(&client.APIError{StatusCode: 0, Message: "The 'teams' command requires API V2. Use --api-version 2 or update your config.", ExitCode: client.ExitInvalidInput})
			}
		},
	}
